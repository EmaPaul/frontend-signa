    ...
    <div className="min-h-screen bg-[#FCECEF] p-4">
      ...
      <div className="max-w-6xl mx-auto"> 
        ...
        <div className="bg-red-400 text-white px-6 py-4 rounded-t-lg flex justify-between items-center">
          <h1 className="text-lg font-semibold">Servicios/Registro de Marca</h1>
        ...
        <div className="md:hidden mt-8">
          <div className="bg-red-400 text-white px-4 py-3 rounded-t-lg">
          ...
          <div className="bg-white border border-gray-200 rounded-b-lg">
            <div className="p-4 border-b">
              <button
                onClick={handleRefresh}
                className="w-full bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded text-sm font-medium flex items-center justify-center gap-1"
              >
                <RefreshCw className="w-4 h-4" />
                Actualizar
              </button>
                ...
                <div key={marca.id} className="p-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm">{typeof marca.titular === 'string' ? marca.titular : "N/A"}</p>
                    </div>
                    <div>
